 ...
 * never parses exception strings. retryDelayMs carries Retry-After / retry-after-ms.
 *
 * Design source: codex ApiError taxonomy (openai/codex, codex-api/src/error.rs)
 * combined with kai PRD section 4.7 LLMError.Code.
 */
data class LLMError(
